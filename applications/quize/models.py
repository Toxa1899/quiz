...
class QuizType(models.Model):
    name = models.CharField(max_length=100, blank=True, null=True, verbose_name="Название типа викторины")
...
class QuizQuestion(models.Model):
    quiz_id = models.ForeignKey(Quiz, on_delete=models.CASCADE, verbose_name="Внешний ключ на quiz_quiz (викторина)")
...
class QuizResult(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Внешний ключ на пользователя')
    quiz = models.ForeignKey(Quiz, on_delete=models.CASCADE, verbose_name="Внешний ключ на quiz_quiz (викторина)")
